...
class AnimeCharacterBot {
    ...
    getAdaptiveDelay(characterCount = 1) {
        const baseDelay = 500; // Increased from 50 to 2000ms (2 seconds)
        const perCharacterDelay = 100; // Increased from 100 to 500ms
        ...
        return calculatedDelay * 0.1; // Increased multiplier from 1.1 to 1.5
    }
